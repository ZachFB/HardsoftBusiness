            ...
            <div id="slider-2" className="flex transition-transform duration-500 gap-3">
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        ...
                        📊 Génération automatique de rapports et audits financiers
                        </span>
                        <p className="font-light text-[16px]">
                        Nos agents IA analysent les données comptables et génèrent des rapports détaillés pour faciliter les audits et améliorer la transparence financière.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        🔎 Surveillance continue et alerte en cas d’anomalie
                        </span>
                        <p className="font-light text-[16px]">
                        L’IA scrute les transactions en temps réel pour détecter les incohérences, prévenir la fraude et garantir la conformité réglementaire.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        💡 Optimisation des stratégies d’investissement et de croissance                        
                        </span>
                        <p className="font-light text-[16px]">
                        Nos solutions utilisent des modèles prédictifs pour anticiper les tendances du marché et orienter les décisions financières vers des choix plus stratégiques et rentables.
                        </p>
                    </div>
                </div>
            </div>
