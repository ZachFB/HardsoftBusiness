...
const page = () => {
  return (
    <div className='w-full'>
      <div className='w-full flex lg:flex-row flex-col h-auto bg-[#0000FF] md:py-0 py-32 mt-[150px] rounded-lg'>

        <section className='flex  w-full lg:w-[52%] lg:h-[575px] h-[400px] text-white'>
