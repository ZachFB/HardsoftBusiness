...
const Service = () => {
    ...
    return (
        ...
        <div className="w-full overflow-hidden mb-20">
                ...
                <div
                    className="w-full max-w-[1300px] h-auto lg:h-[600px] bg-[#F8F8FC] rounded-[15px] mt-[150px] flex flex-col lg:flex-row items-center gap-4 md:gap-10 lg:gap-4 py-4">
                    {/* <!-- Texte --> */}
            ...
            <div className="mt-[108px] max-w-full bg-[#F8F8FC] pb-24 flex flex-col items-center">
                ...
                <div className="mt-[120px] w-full lg:w-[95%] lg:h-[350px] h-auto grid lg:grid-cols-3 grid-col-1 lg:px-auto place-content-center gap-[29px]">
            ...
            <div className="w-full flex justify-center">
                <div className="mt-[84px] w-full h-auto lg:h-[403px] flex flex-col lg:flex-row items-center">
                    <div
                        className="lg:w-[625px] w-full h-full bg-center bg-cover rounded-l-2xl" style={{ backgroundImage: `url(images/ser9.jpg)` }}>
                    </div>
                    <div
            ...
            <div className="w-full flex justify-center">
                <div className="mt-[42px] w-full lg:h-[400px] lg:shadow-transparent shadow-lg h-auto flex flex-col lg:flex-row items-center ">
                    <section className="lg:w-[450px] w-full lg:h-full h-[400px]" style={{ backgroundImage: `url(/images/baner1.svg)` }}></section>
                    <div
                        className="lg:w-[875px] h-[395px] w-full lg: border border-[#0000004D] border-l-none rounded-r-3xl flex justify-center items-center">
