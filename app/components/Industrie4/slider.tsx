        ...
        <div id="slider-container-2" className="overflow-hidden w-full h-[700px] mt-[25px] md:mt-[52px] border-b border-[#00000026]">
            <div id="slider-2" className="flex transition-transform duration-500 gap-3">
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                         📊 Assistance aux diagnostics et recommandations thérapeutiques
                        </span>
                        <p className="font-light text-[16px]">
                       Nos agents IA analysent les antécédents médicaux et les symptômes pour aider les médecins à poser des diagnostics précis et suggérer des options de traitement.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        📦 Gestion automatisée des stocks de médicaments et équipements
                        </span>
                        <p className="font-light text-[16px]">
                        L’IA anticipe la demande en fonction des tendances saisonnières et des besoins hospitaliers, garantissant un approvisionnement optimal et évitant les pénuries.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        💡 Optimisation des plannings et réduction de la charge administrative
                        </span>
                        <p className="font-light text-[16px]">
                        Nos solutions automatisent la gestion des dossiers médicaux, facilitent la prise de rendez-vous et réduisent le temps consacré aux tâches administratives pour un meilleur suivi des patients.
                        </p>
                    </div>
                </div>
            </div>
