...
const Slider = () => {
    useEffect(() => {
        ...
        const totalCards = 4; // Nombre de cartes originales
    ...
    return (
        <div className="h-[595px] w-full border-b border-[#00000026] mt-[66px]">
            ...
            <div className="flex flex-col md:flex-row w-full gap-10 md:gap-0 lg:gap-48">
                ...
                Notre solution logicielle de <span className="text-[28px] lg:text-[40px] bg-gradient-to-r from-[#0000FF] to-[#00FFFF] bg-clip-text text-transparent leading-[10px] lg:leading-[48px]">Production Performance Management</span> vous propose principalement :
                </span>
                ...
                <div id="slider" className="flex transition-transform duration-500 gap-[32px]">
                    ...
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        ...
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[301px]">Un suivi en temps réel de la performance de production pour identifier les points faibles et les axes d'amélioration continue.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        <Image src="/images/carrousel2.gif" className="w-full h-full" height={100} width={100} alt="Carte 2" />
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[344px]">Des outils d'analyse financière pour une gestion budgétaire optimisée en lien direct avec la production.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        <Image src="/images/cart2.svg" className="w-full h-full" height={100} width={100} alt="Carte 3" />
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[307px]">Une planification stratégique de la maintenance incluant des modules pour la maintenance préventive et curative, afin de maximiser la disponibilité des équipements.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        <Image src="/images/cart4.svg" className="w-full h-full" height={100} width={100} alt="Carte 4" />
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[301px]">Des fonctionnalités de gestion de l'énergie pour surveiller et optimiser la consommation énergétique, réduisant ainsi les coûts et l'impact environnemental.</p>
                        </div>
                    </div>
                </div>
            </div>
