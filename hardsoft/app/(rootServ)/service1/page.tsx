...
const Service = () => {
        ...
        <div className="w-full overflow-hidden">
            ...
            <div className="lg:h-[525px] h-auto w-full mt-[94px]">
                ...
                <section className="flex lg:mt-0 mt-3">
                    ...
                    <div className="w-[1173px] h-[180px] border-[#00000026] border relative flex pl-9">
                        <section className="w-[314px] h-[236px] absolute bottom-[30px] flex flex-col py-[18px]">
                            ...
                            <div>
                                ...
                                <p className="poppins-medium w-[333px]">
    ...
    <div className="w-full lg:flex justify-center hidden">
        <div className="mt-[94px] flex w-[1115px] h-[399px] border border-[#0000004D] rounded-r-[25px] rounded-l-[50px]">
