            ...
            <div id="slider-2" className="flex transition-transform duration-500 gap-3">
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        ...
                        📡 Surveillance en temps réel des réseaux énergétiques
                        </span>
                        <p className="font-light text-[16px]">
                        Nos agents IA collectent et analysent en continu les données de production et de consommation pour ajuster l’allocation des ressources.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        ...
                        <p className="font-light text-[16px]">
                        L’IA améliore l’intégration de l’éolien, du solaire et de l’hydroélectrique en équilibrant l’offre et la demande.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        ♻️ Gestion intelligente des déchets et des émissions
                        </span>
                        <p className="font-light text-[16px]">
                        Grâce à des algorithmes avancés, l’IA identifie les sources de gaspillage et propose des solutions pour minimiser l’impact environnemental.
                        </p>
                    </div>
                </div>
            </div>
