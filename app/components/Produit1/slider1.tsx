        ...
        <div className="h-[595px] w-full border-b border-[#00000026] mt-[66px]">
            ...
            <div className="flex flex-col md:flex-row w-full gap-10 md:gap-0 lg:gap-48">
                <span className="w-full md:w-[700px] lg:w-[1000px] md:h-[120px] text-[28px] lg:text-[38px] poppins-semibold ml-[20px] md:ml-[68px] font-black">
                    Notre solution <span className="text-[28px] lg:text-[40px] bg-gradient-to-r from-[#0000FF] to-[#00FFFF] bg-clip-text text-transparent leading-[10px] lg:leading-[48px]">Investment Performance Management</span> vous propose principalement :
                </span>
                ...
                <div id="slider" className="flex transition-transform duration-500 gap-[32px]">
                    ...
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        ...
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[301px]">Des outils de montage financier pour structurer et optimiser les dossiers d'investissement.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                    ...
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        ...
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[307px]">Une plateforme de gestion budgétaire avancée pour aligner les dépenses avec les objectifs financiers et stratégiques.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
