...
const deploymentOptions = [
  {
    ...
    text: `Etablissement d’enseignement et les colonies des vacances`,
  },
  {
    icon: "/images/icon13.svg",
    text: `Bibliothèques, Centres de documentation ou de consultation d’archives,`,
  },
  {
    icon: "/images/icon14.svg",
    text: `Etablissement de culte`,
  },
];

const DeploymentSection3 = () => {
  return (
    <div className="">
...
export default DeploymentSection3;