...
const deploymentOptions = [
    {
        ...
        text: `Etablissement Sportifs`,
    },
    {
        icon: "/images/icon13.svg",
        text: `Musée, Salle d’exposition ou d’évènements`,
    },

];

const DeploymentSection4 = () => {
    return (
        <div className="">
            ...
            <div className="mt-[79px] lg:h-auto">
                <section className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:w-[450px] w-full h-[220px] border border-[#00000026] relative hidden lg:flex justify-center">
...
export default DeploymentSection4;