            ...
            <div id="slider-2" className="flex transition-transform duration-500 gap-3">
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        ...
                        🎦 Analyse et alerte automatique des flux vidéo
                        </span>
                        <p className="font-light text-[16px]">
                        Nos agents IA scannent les images pour repérer toute activité inhabituelle et notifier immédiatement les responsables de sécurité.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        ...
                        <p className="font-light text-[16px]">
                        L’IA renforce la protection des espaces et des systèmes en régulant et en vérifiant les accès en fonction des niveaux d’autorisation.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        📊 Rapports et analyses prédictives des incidents
                        </span>
                        <p className="font-light text-[16px]">
                        Nos agents IA compilent les données des événements passés pour identifier des tendances et prévenir les risques futurs.
                        </p>
                    </div>
                </div>
            </div>
