...
const Slider = () => {
    useEffect(() => {
        ...
        const totalCards = 3; // Nombre de cartes originales
    ...
    return (
        <div className="h-[595px] w-full border-b border-[#00000026] mt-[66px]">
            ...
            <div className="flex flex-col md:flex-row w-full gap-10 md:gap-0 lg:gap-48">
                ...
                Notre solution logicielle de <span className="text-[28px] lg:text-[40px] bg-gradient-to-r from-[#0000FF] to-[#00FFFF] bg-clip-text text-transparent leading-[10px] lg:leading-[48px]">Enterprise Performance Innovation</span> vous propose principalement :
                </span>
                ...
                <div id="slider" className="flex transition-transform duration-500 gap-[32px]">
                    ...
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        ...
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[301px]">Des outils de budgétisation financière permettant de planifier et de gérer les budgets liés aux initiatives d'innovation, en intégrant les risques et les incertitudes spécifiques à l'innovation.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        <Image src="/images/carrousel2.gif" className="w-full h-full" height={100} width={100} alt="Carte 2" />
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[344px]">Des modules de prévisions financières qui utilisent des données en temps réel pour ajuster les prévisions de coûts et de revenus associés aux projets d'innovation.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        <Image src="/images/cart2.svg" className="w-full h-full" height={100} width={100} alt="Carte 3" />
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[307px]">Des fonctionnalités de planification stratégique pour s'assurer que les projets d'innovation sont alignés avec les objectifs stratégiques de l'entreprise, tout en maximisant le retour sur investissement (ROI).</p>
                        </div>
                    </div>
                </div>
            </div>
