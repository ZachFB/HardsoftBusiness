...
const deploymentOptions = [
  {
    ...
    text: `Accélération de l'Innovation : "Libérez du temps pour l'innovation en automatisant les tâches administratives et financières."`,
  },
  {
    icon: "/images/icon2.svg",
    text: `Visibilité Totale : "Obtenez une vue d'ensemble de vos finances et de vos projets pour une meilleure prise de décision."`,
  },
  {
    icon: "/images/icon3.svg",
    text: `Soutien à la Levée de Fonds : "Présentez des rapports financiers clairs et détaillés aux investisseurs pour faciliter la levée de fonds."`,
  },
];

const DeploymentSection1 = () => {
  return (
    <div className="">
...
export default DeploymentSection1;