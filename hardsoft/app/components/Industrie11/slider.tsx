            ...
            <div id="slider-2" className="flex transition-transform duration-500 gap-3">
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        ...
                        📊 Collecte et analyse intelligente des données publiques
                        </span>
                        <p className="font-light text-[16px]">
                        Nos agents IA traitent des données démographiques, économiques et sociales pour guider l’élaboration des politiques.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        🏛️ Modernisation des services publics et automatisation des démarches
                        </span>
                        <p className="font-light text-[16px]">
                        L’IA simplifie l’accès aux services gouvernementaux, réduit la bureaucratie et améliore la satisfaction des citoyens.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        📢 Engagement citoyen et gouvernance participative
                        </span>
                        <p className="font-light text-[16px]">
                        Grâce à l’analyse des feedbacks et aux plateformes interactives, l’IA facilite la prise en compte des attentes des citoyens.
                        </p>
                    </div>
                </div>
            </div>
