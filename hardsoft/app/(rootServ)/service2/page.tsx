...
import SliderServ from '@/app/components/Service2/slider'
    ...
    return (
        <div className="w-full overflow-hidden mb-20">
            ...
            <div className="max-w-full lg:w-full">
                <h1 className="lg:mt-[129px] mt-[80px] lg:ml-[120px] lg:text-left text-center mx-3 text-[28px] lg:text-[40px] font-black">Nos consultants en <span
                    ...
                    management</span> peuvent intégrer à notre suite logicielle, pour vous aider :</h1>
            </div>
                ...
                <div className="mt-[69px] w-full lg:h-[350px] h-auto grid lg:grid-cols-3 grid-col-1 lg:pl-1 place-content-center gap-[29px]">
                    <div className="max-w-[380px] py-4 h-[450px] bg-white rounded-[20px] flex items-center pt-8">
                        <div className="w-full h-full flex flex-col gap-5 items-center justify-center ">
                            ...
                            <h2 className="w-[330px] text-[20px] poppins-semibold text-center font-black">Lors des phases critiques de
                                croissance :</h2>
                            <p className="poppins-light text-center w-[330px] leading-[19.2px]"> Lorsque votre entreprise connaît
                                une expansion rapide, nos consultants interviennent pour structurer et optimiser les processus
                                managériaux afin de soutenir cette croissance. Ils aident à mettre en place des systèmes qui
                                permettent de gérer efficacement l'augmentation des volumes de travail, des clients, ou des
                                produits.</p>
                        </div>
                    </div>
                    <div className="max-w-[380px] py-4 h-[450px] bg-white rounded-[20px] flex items-center pt-6">
                        <div className="w-full h-full flex flex-col gap-7 items-center justify-center">
                            ...
                            <p className="poppins-light text-center w-[330px] leading-[19.2px]">Si votre entreprise traverse une
                                réorganisation interne, une fusion, une acquisition, ou un changement de leadership, nos
                                consultants fournissent des conseils pour assurer une transition en douceur. Ils aident à
                                redéfinir les rôles, à réaligner les équipes et à garantir que la nouvelle structure soutient
                                les objectifs stratégiques.</p>
                        </div>
                    </div>
                    <div className="w-[380px] py-4 h-[450px] bg-white rounded-[20px] flex items-center pt-8">
                        <div className="w-full h-full flex flex-col gap-6 items-center justify-center">
                            ...
                            <p className="poppins-light text-center w-[330px] leading-[19.2px]">Lorsqu'une entreprise décide de
                                changer de cap stratégique, que ce soit en réponse à des changements du marché, à des nouvelles
                                opportunités, ou à des menaces externes, nos consultants sont là pour guider le processus. Ils
                                assistent dans la révision des objectifs, la communication des nouvelles priorités aux équipes,
                                et l'adaptation des opérations pour aligner l'entreprise sur la nouvelle stratégie.</p>
                        </div>
                    </div>
                </div>
           ...
           <div className="flex justify-center mt-10">
            <h1 className="mt-[114px] text-[28px] lg:text-[40px] w-[980px] text-center font-black">
            Comment en temps réel nos consultants peuvent un cadre structuré pour améliorer
             <span className="lg:mt-8 mt-4 text-[30px] font-semibold lg:text-[40px] bg-gradient-to-r from-[#0000FF] to-[#00FFFF] bg-clip-text text-transparent leading-[38px] lg:leading-[48px]"> la gestion et la performance </span> 
             de l'entreprise tout en alignant les actions sur les objectifs stratégiques ?
            </h1>
           </div>
        ...
        <div className="w-full  lg:h-[550px] py-8 lg:py-0 bg-[#0000FF] flex items-center">
            <div className="lg:w-[981px] w-full py-auto flex px-3 lg:px-0 ml-0 lg:ml-20 gap-[159px]">
                <div className="flex flex-col text-white">
                    <h1 className="lg:w-[787px] w-full text-[28px] lg:text-[40px] font-black lg:leading-[48px] text-justify">Pourquoi auriez vous
                        besoin des avis, des conseils et des recommandations de nos consultants ? </h1>
                    <SliderServ/>
                </div>
            </div>
            <ProgressGradient/>
