        ...
        <div className="h-[595px] w-full border-b border-[#00000026] mt-[66px]">
            ...
            <div className="flex flex-col md:flex-row w-full gap-10 md:gap-0 lg:gap-48">
                <span className="w-full md:w-[700px] lg:w-[1000px] md:h-[120px] text-[28px] lg:text-[38px] poppins-semibold ml-[20px] md:ml-[68px] font-black">
                    Notre solution <span className="text-[28px] lg:text-[40px] bg-gradient-to-r from-[#0000FF] to-[#00FFFF] bg-clip-text text-transparent leading-[10px] lg:leading-[48px]">Enterprise Perfomance Commercial</span> (EPC) vous propose principalement :
                </span>
                ...
                <div id="slider" className="flex transition-transform duration-500 gap-[32px]">
                    ...
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        ...
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[301px]">Des outils de budgétisation financière vous permettant de planifier les budgets marketing et commerciaux en fonction des objectifs stratégiques.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        <Image src="/images/carrousel2.gif" className="w-full h-full" height={100} width={100} alt="Carte 2" />
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[344px]">Des modules de prévisions financières qui intègrent les données de performance marketing et commerciale pour des prévisions précises des revenus et des coûts.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        <Image src="/images/cart2.svg" className="w-full h-full" height={100} width={100} alt="Carte 3" />
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[307px]">Des fonctionnalités de planification stratégique : pour aligner les campagnes marketing et les efforts commerciaux avec les objectifs à long terme de l'entreprise.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
