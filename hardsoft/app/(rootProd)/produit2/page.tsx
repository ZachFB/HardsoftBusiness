import InvestmentBenefits from "@/app/components/Produit2/Benefit";
import DeploymentSection from "@/app/components/Produit2/EtreDeployer";
import InvestmentPerformance from "@/app/components/Produit2/fonctionnement";
import Slider from "@/app/components/Produit2/slider1";
import Slider2 from "@/app/components/Produit2/slider2";
            ...
            <div className="px-4">
                <div
                    ...
                    <div className="w-full lg:w-[50%] flex flex-col items-center lg:items-start lg:pl-8 text-center lg:text-left">
                        ...
                        <span
                            className="lg:mt-8 mt-4 text-[30px] font-semibold lg:text-[40px] bg-gradient-to-r from-[#0000FF] to-[#00FFFF] bg-clip-text text-transparent leading-[38px] lg:leading-[48px]">
                             Enterprise Perfomance Commercial
                        </span>
                        <span className="mt-[20px] lg:mt-[40px] text-[18px] lg:text-[23px] text-[#494949] font-medium">
                         Optez pour une planification stratégique pour votre acquisition clientèle !
                        </span>
                    ...
                    <div className="w-full md:w-[80%] lg:w-[50%] h-[250px] md:h-[350px] lg:h-[494px] rounded-r-[15px] bg-cover bg-center"
                        style={{ backgroundImage: `url(/images/heroProd2.jpg)` }}></div>
                </div>
            </div>
            ...
            <div className="w-full lg:h-[488px] px-[87px] border-b border-[#00000026]">
                <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-[20px]">
                    <div className="flex flex-col gap-4 py-[20px]">
                        ...
                        <p className="poppins-medium">Directeur marketing et avez besoin d’aligner les stratégies marketing avec les objectifs financiers de l'entreprise.</p>
                    </div>
                    <div className="flex flex-col gap-4 py-[20px]">
                        <span className="w-[100px] h-[80px]">
                            <Image src="images/Group.svg" className="m-auto mt-2 h-20 w-20" height={100} width={100} alt="" />
                        </span>
                        <p className="poppins-medium">Responsable commercial et souhaitez optimiser les efforts de vente et maximiser les revenus.</p>
                    </div>
                    <div className="flex flex-col gap-4 py-[20px]">
                        <span className="w-[100px] h-[80px]">
                            <Image src="images/Vector1.svg" className="m-auto mt-2 h-20 w-20" height={100} width={100} alt="" />
                        </span>
                        <p className="poppins-medium">Directeur financier et devez intégrer les données marketing et commerciales dans la budgétisation et les prévisions financières..</p>
                    </div>
                    <div className="flex flex-col gap-4 py-[20px]">
                        <span className="w-[100px] h-[80px]">
                            <Image src="images/Group1.svg" className="m-auto mt-2 h-20 w-20" height={100} width={100} alt="" />
                        </span>
                        <p className="poppins-medium">Planificateur stratégique et  devez assurer que les stratégies marketing et commerciales sont alignées avec les objectifs globaux de l'entreprise.</p>
                    </div>
                </div>
            </div>
