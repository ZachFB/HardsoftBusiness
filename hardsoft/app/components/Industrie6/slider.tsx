            ...
            <div id="slider-2" className="flex transition-transform duration-500 gap-3">
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        ...
                        📊 Analyse et gestion des sols en temps réel
                        </span>
                        <p className="font-light text-[16px]">
                        Nos agents IA évaluent la qualité des sols, recommandent les meilleurs fertilisants et ajustent les pratiques agricoles pour un rendement optimal.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        🌦️ Anticipation des conditions climatiques et adaptation des cultures
                        </span>
                        <p className="font-light text-[16px]">
                        L’IA analyse les prévisions météorologiques et aide à ajuster les pratiques agricoles pour minimiser les risques liés aux intempéries.
                        </p>
                    </div>
                </div>
                ...
                <div className="card lg:min-w-[80%] min-w-[90%] mx-4 h-[597.69px] bg-contain bg-left bg-no-repeat border-[#00000026] border rounded-[25px] flex flex-col justify-center lg:items-end items-center"
                    ...
                    <div className="lg:w-1/2 w-[80%] lg:pr-16 lg:bg-transparent bg-[#a3f7ffd3] p-6 rounded-xl">
                        <span className="block md:text-[28px] text-[16px] md:leading-[48px] leading-[24px] font-black mb-6">
                        🚜 Gestion intelligente des chaînes d’approvisionnement agricoles
                        </span>
                        <p className="font-light text-[16px]">
                        De la production à la distribution, l’IA facilite la logistique et optimise les circuits de commercialisation pour limiter les pertes et améliorer la rentabilité.
                        </p>
                    </div>
                </div>
            </div>
