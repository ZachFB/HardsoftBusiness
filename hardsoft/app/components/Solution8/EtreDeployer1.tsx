...
const deploymentOptions = [
  {
    ...
    text: `Structures d’accueil pour personnes âgées et personnes handicapées`,
  },
  {
    icon: "/images/icon13.svg",
    text: `Salle à usage d’audition, de conférence, de réunion, de spectacle, ou usage multiple`,
  },
  {
    icon: "/images/icon14.svg",
    text: `Magasin de vente ou centres commerciaux`,
  },
];
