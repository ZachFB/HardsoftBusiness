    ...
    return (
        <div className="h-[595px] w-full border-b border-[#00000026] mt-[66px]">
            ...
            <div className="flex flex-col md:flex-row w-full gap-10 md:gap-0 lg:gap-48">
                ...
                Notre solution logicielle de <span className="text-[28px] lg:text-[40px] bg-gradient-to-r from-[#0000FF] to-[#00FFFF] bg-clip-text text-transparent leading-[10px] lg:leading-[48px]">Supply Chain Performance</span> vous propose principalement :
                </span>
                ...
                <div id="slider" className="flex transition-transform duration-500 gap-[32px]">
                    ...
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        ...
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[301px]">Des outils de budgétisation financière qui intègrent les coûts logistiques, les stocks, et les flux de marchandises.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        <Image src="/images/carrousel2.gif" className="w-full h-full" height={100} width={100} alt="Carte 2" />
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[344px]">Des outils de prévisions financières basés sur les données en temps réel de la chaîne d'approvisionnement, permettant d'anticiper les besoins de financement et de gestion des ressources.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
                        <Image src="/images/cart2.svg" className="w-full h-full" height={100} width={100} alt="Carte 3" />
                        <div className="text-left w-full md:w-[380px]">
                            <p className="mt-[26px] poppins-light text-[16px] w-[307px]">Des fonctionnalités de planification stratégique qui tiennent compte des capacités matérielles de la chaîne d'approvisionnement pour élaborer des stratégies durables et rentables.</p>
                        </div>
                    </div>
                    <div className="card flex flex-col justify-center w-full md:w-[380px] h-full">
