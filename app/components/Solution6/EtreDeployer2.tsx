...
const deploymentOptions = [
  {
    ...
    titre: "Accélération de la Croissance :",
    text: `"Soutenez la croissance rapide de votre entreprise avec des solutions qui évoluent en même temps que vous."`,
  },
  {
    icon: "/images/icon2.svg",
    titre: "Amélioration de l'Efficacité :",
    text: `"Automatisez les processus pour améliorer l'efficacité opérationnelle et réduire les coûts."`,
  },
  {
    icon: "/images/icon3.svg",
    titre: "Optimisation des Décisions Stratégiques :",
    text: `"Prenez des décisions basées sur des données précises et des analyses prédictives pour maximiser la rentabilité."`,
  },
];

const DeploymentSection2 = () => {
  return (
    <div className="">
...
export default DeploymentSection2;